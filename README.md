# mern-user-skeleton
This MERN stack implementation creates a small web application utilizing the MBTA system's API that lets users learn real time MBTA train information, register, login, view a home page,  logout. 
